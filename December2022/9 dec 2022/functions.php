   ...
   if($daily_promo):
    foreach ($daily_promo as $key => $value) {
        ...
        if ($select_days) {
            ...
            if (strtolower($select_days) == $today) {
                if($main_title):
                    ...
                    if($subtitle && $subtitle_two):
                        ...
                        $none_selectecd = get_option('date_format');
                        if($price):
                                        ...
                                        foreach ($days as $key => $day)
                                            ...
                                            if (strtolower($day) == $today)
                                            {
                                                ...
                                                foreach($drink_child_repeater as $drink_child_repeaters) { the_row(); 
                                                 ...
                                                 echo '<div class="inner-area">';
                                                 printf( '<h3>%s %s %s</h3>', $drink_main_title, $drink_title, $drink_price );
                                                 echo $content;
                                                 echo '</div>';
...
//     // GET DRINKS
    ...
    {
        $num++;
        if( $count == $num && $today != $select_days)
        {
            echo '<div class="content">';
            echo '<div class="offdays">';
            the_field('none_selected_content', 'option' );
                echo '</div>'; //content
            echo '</div>'; //content

        }
    }
    // else if( $today != $select_days)
    //     echo 'The message'.get_field('none_selected_content', 'option' );
